...
function home() {
  return (
    ...
    <Projec img1={Todoapp} title="Wztask" description="Website for manage todo or task" />
        <Projec img1={Wowitem} title="Wowitem" description="Website for borrowing item "  />
        <Projec img1={porto} title="Portofolio" description="Portofolio website with admin page" />
        <Projec img1={apt} title="APT portofolio" description="Portofolio website " />
        <Projec img1={Wizard} title="WizardWake" description="Game webiste" />
        <Projec img1={Space} title="Space Around" description="Game Website" />
        <Projec img1={coffe} title="CoffeIN" description="myfirst project website" />
