  ...
  return (
    ...
    <div 
     className=" lg:w-1/2 lg:p-6  h-40 xl:px-10 md:text-start text-center"> 
      ...
      <Link data-aos="fade-left" to={'/about'} className="px-5 p-2 bg-slate-600 text-white rounded-lg">
        learn more
      </Link>
    ...
    <div  className="sm:w-3/5 w-4/5 mx-auto md:mx-0  relative  group p-6  overflow-hidden rounded-md cursor-pointer flex justify-center  sm:h-[34rem] h-96">
        <div data-aos="fade-left" data-aos-duration="2000" className="bg-slate-400 absolute md:w-64 w-48 h-72  md:h-96 left-0 top-6 lg:left-20 hover:scale-105 transition-all brightness-75 z-10" style={{ backgroundImage: `url(${me1})`, backgroundSize: "cover", backgroundPosition: "center" }} ></div>
        <div data-aos="zoom-in" data-aos-duration="3000" className="bg-slate-400 absolute md:w-64 w-48 h-72 md:h-96  bottom-6 right-0 hover:scale-105 transition-all  brightness-75 z-10" style={{ backgroundImage: `url(${me2})`, backgroundSize: "cover"  }}></div>
